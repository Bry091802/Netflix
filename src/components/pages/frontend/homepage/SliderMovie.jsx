...
const SliderMovie = ({title, filter = ""}) => {
  ...
  const getFilterMovie = () => movies.filter((item) => item.movie_category === filter)
    ...
    <>
      <section className="slider-parent bg-dark -mt-5 relative px-4">
            ...
            {getFilterMovie().map((item, key) => (           
              ...
              <div className="slider-card translate-y-5 group">
                ...
                <div className="slider-zoom absolute top-0 left-0 transition-all ease-in-out duration-200 group-hover:scale-[1.1]">
                  ...
                  <div className="bg-dark slider-zoom-info p-4 rounded-b-md shadow-lg invisible group-hover:visible opacity-0
                  group-hover:opacity-100 transition-all ease-linear duration-200">
        ...
        <button
          ...
          className="slide-nav-btn absolute top-[17.8%] z-[1] h-[180px] w-[50px] bg-black bg-opacity-40 opacity-0 transition-opacity hover:opacity-100"
        >
        ...
        <button
          ...
          className="slide-nav-btn absolute top-[17.8%] right-4 z-[1] h-[180px] w-[50px] bg-black bg-opacity-40 opacity-0 transition-opacity hover:opacity-100"
        >
