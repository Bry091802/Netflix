        ...
        -translate-y-1/2 max-w-[800px] w-full rounded-md border border-line">
                ...
                <div className='grid grid-cols-[1fr_,250px] gap-5'>
                    <div>
                        <ul className='flex gap-3 items-center text-xs mb-3'>
                            <li  className='border-[1px] border-dark py-1 px-2.5 text-[12px] leading-none'><span className="translate-y-[1px] block">{movieInfo.movie_rating}</span></li>
            ...
            <div className="modal-more p-4">
                <div className="grid grid-cols-3 gap-5">
                        ...
                        <div className="card relative rounded-md overflow-hidden" key={key}>
                        ...
                        <li  className='border-[1px] border-dark py-1 px-2.5 text-[12px] leading-none'><span className="translate-y-[1px] block">{item.movie_rating}</span></li>
                            <li>{item.movie_year}</li>
                            <li className='border-[1px] border-dark py-[0.5px] px-1.5 text-[9px]'>HD</li>
                        </ul>
                        <button className='size-[50px] rounded-full border-[1px] border-dark center-all'><Plus/></button>
                        </div>
                        <p className='text-xs leading-relaxed text-balance line-clamp-3'>{item.movie_summary}</p>
                        </div>
                    </div>
                ))}            
